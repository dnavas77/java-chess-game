...
public class Bishop implements Piece {
	...
	/**
	 * Holds flag to determined if this piece has moved
	 */
	 ...
	 */
	public Bishop(String name, boolean isWhite, boolean isBlack, int x, int y, Engine e) {
		this.x = x;
		this.y = y;
		this.engine = e;
		this.name = name;
	...
	/**
	 * Rolls back the position of this piece to previous
	 */
	...
	public boolean isLegalMove(Piece target, int targetX, int targetY) {
		...
		if (SharedRules.isDiagonalMove(x, y, targetX, targetY, board, false)) {
			return true;
		}
		return false;
	}	
