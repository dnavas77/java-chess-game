...
public class Queen implements Piece {
	 ...
	 */
	public Queen(String name, boolean isWhite, boolean isBlack, int x, int y, Engine e) {
		this.x = x;
		this.y = y;
		this.engine = e;
		this.name = name;
	...
	public boolean isLegalMove(Piece target, int targetX, int targetY) {
		...
		if (
			SharedRules.isVerticalOrHorizontalMove(x, y, targetX, targetY, board, false) ||
			SharedRules.isDiagonalMove(x, y, targetX, targetY, board, false)
		) {
			return true;
		}
		return false;
